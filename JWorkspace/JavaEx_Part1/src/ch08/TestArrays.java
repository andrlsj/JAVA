...
public class TestArrays {
	...
	public static void main(String[] args) {
		...
		int[] intArray4 = {100,255,355};
		int[] intArray4b = Arrays.copyOf(intArray4, intArray4.length);
		intArray4[0] = 0;
		System.out.println(intArray4[0]);
		System.out.println(intArray4b[0]);
		...
		int[] intArray5 = {100, 200, 300, 50};
		Arrays.sort(intArray5);
		int i3 = Arrays.binarySearch(intArray5,	50);
		int i4 = Arrays.binarySearch(intArray5,	150);
