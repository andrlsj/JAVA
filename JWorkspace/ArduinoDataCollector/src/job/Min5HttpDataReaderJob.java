...
public class Min5HttpDataReaderJob implements Job {
	private static Logger logger = Logger.getLogger(Min5HttpDataReaderJob.class);
	...
	public static void main(String[] args) {
		System.out.println("Min5HttpDataReaderJob run...");
		//ExecutorService exec = Executors.newFixedThreadPool(10);
		List<Snc01> lstSNC01 = getEnableSNCX01SByMins((String) hm.get("ArduinoDBServerIP"), (String) hmSite.get("site"),"5");
...
//		}
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		logger.info("Min5HttpDataReaderJob run...");
		List<Snc01> lstSNC01 = getEnableSNCX01SByMins((String) hm.get("ArduinoDBServerIP"), (String) hmSite.get("site"),"5");
		if(lstSNC01.size()==0)
			return;
		ExecutorService exec = Executors.newFixedThreadPool(10);
