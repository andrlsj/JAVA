...
public class Min60HttpDataReaderJob implements Job {
	private static Logger logger = Logger.getLogger(Min60HttpDataReaderJob.class);
	...
	public static void main(String[] args) {
		System.out.println("Min60HttpDataReaderJob run...");
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		logger.info("Min60HttpDataReaderJob run...");
		List<Snc01> lstSNC01 = getEnableSNCX01SByMins((String) hm.get("ArduinoDBServerIP"), (String) hmSite.get("site"),"30");
		if(lstSNC01.size()==0)
			return;
		ExecutorService exec = Executors.newFixedThreadPool(10);
