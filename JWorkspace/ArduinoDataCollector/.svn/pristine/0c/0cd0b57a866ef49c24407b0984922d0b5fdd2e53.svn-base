	...
	<tr>
		<td>
			<table style="width: 300px; margin: auto; font-size:5">
				<tr>
					<td colspan="2" nowrap>
						<h1><%=hmSite.get("site")%>環控收集系統參數管理</h1>					
					</td>
				</tr>
				<tr>
...
<tr>
	<td align="center"><a href="http://192.168.4.161:8090/admin">廠區環境監控服務器管理</td>	
	<td align="center"><a href="http://192.168.4.162/envreports/dashboard">集團廠區環境監控總覽</td>	
	<td colspan="2" align="center"><a href="http://192.168.4.162:8092">CIT 燒機測試區</td>	
</tr>
<tr>
		...
		<td><a href="http://192.168.4.161:8092" target="_blank">昆山廠(CHK)</a></td>
		<td><a href="http://10.12.0.102:8092" target="_blank">天津廠(CZH)</a></td>	
	</tr>
	<tr>
		<td><a href="http://192.168.8.25:8092" target="_blank">煙台廠(CZZ)</a></td>
		<td><a href="http://192.168.12.25:8092" target="_blank">河南廠(CZM)</a></td>
		<td><a href="http://192.168.11.27:8092" target="_blank">重慶廠(CZY)</a></td>	
		<td><a href="http://192.168.3.103:8092" target="_blank">深圳廠(CZF)</a></td>	
		<td><a href="http://192.168.17.24:8092" target="_blank">廣東廠(CZB)</a></td>
		<td><a href=""></a></td>
	</tr>
</table>	
</form>
