...
public class Min15HttpDataReaderJob implements Job {
	private static Logger logger = Logger.getLogger(Min15HttpDataReaderJob.class);
	...
	public static void main(String[] args) {
		System.out.println("Min15HttpDataReaderJob run...");
		//ExecutorService exec = Executors.newFixedThreadPool(10);
		List<Snc01> lstSNC01 = getEnableSNCX01SByMins((String) hm.get("ArduinoDBServerIP"), (String) hmSite.get("site"),"15");
...
//			Min30HttpDataReader dr = new Min30HttpDataReader((String) hm.get("ArduinoDBServerIP"), snc.getIp(),
//					snc.getMachineName());
//			exec.execute(dr);
//		}
	}
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		logger.info("Min15HttpDataReaderJob run...");
		List<Snc01> lstSNC01 = getEnableSNCX01SByMins((String) hm.get("ArduinoDBServerIP"), (String) hmSite.get("site"),"15");
		if(lstSNC01.size()==0)
			return;
		ExecutorService exec = Executors.newFixedThreadPool(10);
