...
/**
 * <p>getDepartmentsByCompanyNoDeptNo complex type 的 Java 類別.
 * 
 * <p>下列綱要片段會指定此類別中包含的預期內容.
 * 
 * <pre>
 * &lt;complexType name="getDepartmentsByCompanyNoDeptNo">
 *   &lt;complexContent>
...
@XmlType(name = "getDepartmentsByCompanyNoDeptNo", propOrder = {
    "strCompanyNo",
    "strDeptNo",
    "strCriteria"
})
public class GetDepartmentsByCompanyNoDeptNo {
