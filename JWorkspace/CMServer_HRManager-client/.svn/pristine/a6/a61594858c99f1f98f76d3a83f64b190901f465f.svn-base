...
/**
 * <p>getAllEmployeesByCompanyNoAndDeptNo complex type 的 Java 類別.
 * 
 * <p>下列綱要片段會指定此類別中包含的預期內容.
 * 
 * <pre>
 * &lt;complexType name="getAllEmployeesByCompanyNoAndDeptNo">
 *   &lt;complexContent>
...
@XmlType(name = "getAllEmployeesByCompanyNoAndDeptNo", propOrder = {
    "strCompanyNo",
    "strDeptNo",
    "bAll"
})
public class GetAllEmployeesByCompanyNoAndDeptNo {
